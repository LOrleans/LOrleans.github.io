    ...
    return (
        <section className="relative overflow-hidden min-h-screen max-w-full flex-col xl:flex lg:flex-row items-center justify-center bg-[#080e1d] xl:gap-14">
            ...
            <div className="max-w-7xl h-[40vh] text-left text-white flex flex-col lg:gap-6 xl:gap-8 justify-evenly items-center px-[8vw] xl:px-0">
                <p className="text-[#3bbffa] text-3xl lg:text-2xl xl:text-lg">FRONTEND ENGINEER & AI SCIENTIST</p>
                <h1 className="text-8xl lg:text-8xl xl:text-7xl text-center font-bold text-white">
                    ...
                    <p className='text-3xl mt-10 xl:text-xl'>I'm a software developer passionate about creating innovative solutions.</p>
                </h1>
                <div className="flex gap-4">
                    <button className="bg-[#ff6f7e] hover:scale-95 hover:cursor-pointer transition-all duration-300 text-white font-bold lg:py-2 py-4 px-4 rounded-2xl text-4xl lg:text-3xl xl:text-xl">See my work</button>
                    <button className="border border-[#3bbffa] text-[#3bbffa] font-bold lg:py-2 py-2 px-4 rounded-2xl hover:cursor-pointer hover:scale-95 transition-all  duration-300 text-4xl lg:text-3xl xl:text-xl">My development stack</button>
                </div>
            </div>
